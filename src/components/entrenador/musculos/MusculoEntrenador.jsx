...
import { ArrowBack, Cancel, Edit, RemoveRedEye } from '@mui/icons-material';
            ...
            <Container >
                ...
                <Grid container spacing={{ xs: 4, sm: 6, md: 6 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                    ...
                    {ejercicios.length > 0
                        ?
                        <Grid item xs={2} sm={2} md={3} >
                            <Button variant="contained" startIcon={<RemoveRedEye />} onClick={handleShowejercicios}>Ver Ejercicios</Button>
                        </Grid>
                        :  <Grid item xs={2} sm={2} md={3} >
...
export default MusculoEntrenador
