...
function EditarPerfilClienteModal(props) {

    const { cliente, showModalEditarPerfil, setShowModalEditarPerfil, onUpdate } = props;
...
export default EditarPerfilClienteModal;